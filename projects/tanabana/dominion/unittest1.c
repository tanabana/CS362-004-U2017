...
int main() 
{
    ...
    if (r == 0) 
    {
        ...
        {
            printf("G.supplyCount[province] = %d.", G.supplyCount[province]);
...
*/
    ...
    G.supplyCount[curse] = 0; //curse defined as 0
    printf("G.supplyCount[curse] = %d.", G.supplyCount[curse]);
    returnVal = isGameOver(&G);
    //assert(returnVal == 0); //Returns 1 when game is over. Returns 0 if game is not over.
    //printf("\tPASS: Game is NOT over.\n");
    assertTrue(0, returnVal, &numOfFails);
...
*/
    ...
    G.supplyCount[treasure_map] = 0; //treasure_map defined as 26, last element of array
    printf("G.supplyCount[treasure_map] = %d.", G.supplyCount[treasure_map]);
    returnVal = isGameOver(&G);
    //assert(returnVal == 0); //Returns 1 when game is over. Returns 0 if game is not over.
...
*/
    ...
    G.supplyCount[mine] = 0; //mine defined as 11
    printf("G.supplyCount[mine] = %d.", G.supplyCount[mine]);
    returnVal = isGameOver(&G);
    //assert(returnVal == 1); //Returns 1 when game is over. Returns 0 if game is not over.
    //printf("\tGame is OVER.\n");
    assertTrue(1, returnVal, &numOfFails);
...
*/
    ...
    printf("G.supplyCount[duchy] = %d.", G.supplyCount[duchy]);
    returnVal = isGameOver(&G);
    //assert(returnVal == 0); //Returns 1 when game is over. Returns 0 if game is not over.
    //printf("\tPASS: Game is NOT over.\n");
    assertTrue(0, returnVal, &numOfFails);
...
*/
    ...
    printf("G.supplyCount[smithy] = %d.", G.supplyCount[smithy]);
    returnVal = isGameOver(&G);
    //assert(returnVal == 0); //Returns 1 when game is over. Returns 0 if game is not over.
    //printf("\tGame is NOT over.\n");
    assertTrue(0, returnVal, &numOfFails);
...
*/
    ...
    G.supplyCount[salvager] = 0; //mine defined as 11
    printf("G.supplyCount[salvager] = %d.", G.supplyCount[salvager]);
    returnVal = isGameOver(&G);
    //assert(returnVal == 1); //Returns 1 when game is over. Returns 0 if game is not over.
    //printf("\tGame is OVER.\n");
    assertTrue(1, returnVal, &numOfFails);
